...
public class NeedsAttention {
	...
	public ModelAndView submitCarpool(@RequestParam String username,
		...
		//Creates list of carpoolers and adds current user and
		...
		Company company = coRepo.findByName(passenger1.getCompany().getName());
...
//		mav.addObject("score", score);
	...
	// This appears to be an unused controller detailing information for a summary page. Can it be deleted? --Sam
	...
	// This appears to be a controller showing employees of a given company, a page linked to
	// from a JSP with no link pointing to it?? Is this controller still relevant? --Sam
	...
	// Possibly outdated, motion to delete --Sam
