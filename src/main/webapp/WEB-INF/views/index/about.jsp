...
<body>
	<main class="container">
		...
		<section class="jumbotron">
			...
			<p>So how do we encourage employees to start pooling their
				resources? By making it simple, easy, and fun.</p>
			<p>The Green on the Go app provides a user-friendly interface
			...
			<p>Not only does the app track emissions by employee, it also
			...
			<p>Simple, easy, and fun means bigger gains for your company and
		...
		<section class="jumbotron">
			...
			<a href="https://www.linkedin.com/in/david-breitenbeck-nc"><h6>David
					Breitenbeck</h6></a> <a href="https://linkedin.com/in/kyle-warchuck"><h6>Kyle
					Warchuck</h6></a> <a href="https://www.linkedin.com/in/rana-siroosian"><h6>Rana
					Siroosian</h6></a> <a
				href="https://github.com/Rana-Siroosian?tab=repositories"><i
				class="fa fa-github"></i></a> <a
				href="https://www.linkedin.com/in/samkeim"><h6>Sam Keim</h6></a>
		</section>
